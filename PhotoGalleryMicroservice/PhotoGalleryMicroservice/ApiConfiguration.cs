...
using System;
using PhotoGalleryMicroservice.App_Start;
using PhotoGalleryMicroservice.Utils;
using PhotoGalleryMicroservice.Config;
using PhotoGalleryMicroservice.Services;
using PhotoGalleryMicroservice.Auth;
using PhotoGalleryMicroservice.Filters;
...
namespace PhotoGalleryMicroservice
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "PhotoGalleryMicroservice"))
                .EnableSwaggerUi();
