...
using System;
using SecurityMicroservice.App_Start;
using SecurityMicroservice.Utils;
using SecurityMicroservice.Config;
using SecurityMicroservice.Services;
using SecurityMicroservice.Auth;
using SecurityMicroservice.Filters;
...
namespace SecurityMicroservice
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "SecurityMicroservice"))
                .EnableSwaggerUi();
