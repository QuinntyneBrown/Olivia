...
using System;
using SearchMicroservice.App_Start;
using SearchMicroservice.Utils;
using SearchMicroservice.Config;
using SearchMicroservice.Services;
using SearchMicroservice.Auth;
using SearchMicroservice.Filters;
...
namespace SearchMicroservice
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "SearchMicroservice"))
                .EnableSwaggerUi();
