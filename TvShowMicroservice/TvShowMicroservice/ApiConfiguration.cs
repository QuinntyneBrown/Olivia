...
using System;
using TvShowMicroservice.App_Start;
using TvShowMicroservice.Utils;
using TvShowMicroservice.Config;
using TvShowMicroservice.Services;
using TvShowMicroservice.Auth;
using TvShowMicroservice.Filters;

namespace TvShowMicroservice
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "TvShowMicroservice"))
                .EnableSwaggerUi();
